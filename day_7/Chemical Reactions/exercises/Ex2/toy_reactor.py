...
k =np.array([100.0, 0.25, 1.0]) #numpy array carrying the rate coefficients k1 = 100, k2=0.25, k3=1
c_0 = np.array([1.0, 0, 0]) #initial composition, i.e., c_0(A) = 1, c_0(B)=c_0(C)=0.0
...
def reactor(c,t,k,S):
    """
        ...
        outputs: 
            dc/dt - numpy array
    """
    return S @ reaction_rates(c,k) # matrix vector multiplication
